...
<div style="width:100%; clear:both; display:inline-block; height:calc(100% - 95px); background-color:#b2c7d9; padding:0px; padding-left:0pxl margin:0px; overflow-y:auto" id="MAIN_CONTENTS">
	<div class="divChatTrMy">
		<div style="float:right; width:45%">
			<div style="width:100%; padding-top:3px; padding-bottom:3px; padding-left:8px; padding-right:8px; background-color:#ffeb33; border-radius:7px">안녕</div>
		</div>
	</div>
	<div class="divChatTr">
		...
		<div style="float:left; margin-left:7px; width:45px">
			<div>스파이더맨</div>
			<div style="width:100%; padding-top:3px; padding-bottom:3px; padding-left:8px; padding-right:8px; background-color:white; border-radius:7px">반가워</div>
		</div>
	</div>
</div>
